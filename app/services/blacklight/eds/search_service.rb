...
module Blacklight::Eds
  class SearchService
    ...
    def initialize(blacklight_config, user_params = {}, eds_params = {})
      ...
      @repository = Blacklight::Eds::Repository.new(blacklight_config)
    ...
    def previous_and_next_documents_for_search(index, request_params, extra_controller_params = {})
      ...
      puts 'REQ PARAMS: ' + request_params.inspect
      puts 'EXTRA CONTROLLER PARAMS: ' + extra_controller_params.inspect
